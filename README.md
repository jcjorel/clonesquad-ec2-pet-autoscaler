...
* Cost optimization
	...
	- (Optional) Extra cost optimization option for non-autoscaled resources: [Static subfleet support](docs/SCALING.md#static-subfleet-support) both for EC2 Instances, RDS databases and TransferFamily servers. Allows simple on/off use-cases (in combination with the scheduler. See [demonstration](examples/environments/demo-scheduled-events/)).
* Resilience
